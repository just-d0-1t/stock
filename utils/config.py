...
# code: 股票/指数/基金 代码
# typ: 类型 1:股票/2:指数/3:基金
def default_data_path(code, typ):
    path = f"{WORK_DIR}/data/{code}_{typ}_data.csv"
    return path

def default_info_path(code, typ):
    path = f"{WORK_DIR}/data/{code}_{typ}_info.csv"
    return path
